...
async function analyzeFiles(files) {
    ...
    let generatedText = allData.map((gmd)=>{
        return gmd["Full Name"] + ", " + gmd["First Seen"] + ", " + gmd["Time in Call"];
    }).map((value)=>"<p>" + value + "</p>").join("\r\n");
    if (generatedText) displayGeneratedInfo(generatedText);
}
...
},{"papaparse":"5w3wE"}],"5w3wE":[function(require,module,exports) {
/* @license
Papa Parse
v5.3.2
