...
var _googleMeetEntry = require("./googleMeetEntry");
var _combinedLogs = require("./combinedLogs");
var _singleMeet = require("./singleMeet");
function init() {
...
function analyzeText(csv) {
    ...
    return _papaparse.parse(newCsv, {
        header: true
    });
}
...
function displayGeneratedInfo(text) {
...
},{"papaparse":"5w3wE","./googleMeetEntry":"dN1mi","./combinedLogs":"8bU7K","./singleMeet":"7TXqn"}],"5w3wE":[function(require,module,exports) {
/* @license
Papa Parse
v5.3.2
...
},{}],"dN1mi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GoogleMeetEntry", ()=>GoogleMeetEntry);
class GoogleMeetEntry {
    constructor(csv){
...
},{}],"8bU7K":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CombinedLogs", ()=>CombinedLogs);
class CombinedLogs {
    meets = [];
    studentsLogs = {};
    constructor(){}
    addStudents(meet) {
        ...
        for (const entry of meet.entries){
            ...
            if (!this.studentsLogs[fullName]) this.studentsLogs[fullName] = [];
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SingleMeet", ()=>SingleMeet);
class SingleMeet {
    constructor(entries){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aaB8B","8tyFx"], "8tyFx", "parcelRequire94c2")
